...
"The variable y contains the mean of 5 values. It was done by calling `x`to a set of numbers and then making the mean of those 5 values be `y`"
```
...
```{r}
v <- c(1, 2, 3, "Hi")
#"^it creates a vector group with everything in it"
#v <- c(1, 2, 3, "Hi") + 1
#^"no it is not valid"
#v <- c(1, 2, 3, FALSE) + 1 
#^"no it is not valid"
...
my_plot <- qplot(x_axis, y_axis, main = "My amazing plot of x_axis versus y_axis",
                 xlab = "My x_axis", ylab = "My y_axis", size = 3)
