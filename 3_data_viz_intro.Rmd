...
#the code does not work because you have put color within the aesthetics
...
ggplot(data = mpg, aes(x = cty, y = hwy, color = class)) + 
  ...
  scale_color_manual(values = c("#D32F2F", "#1976D2", "#388E3C", "#8E44AD", "#F39C12", "#C2185B", "#7B7B7B"))
```
...
# Write your code here
subcompact_data <- mpg %>%
  filter(class == "subcompact", cty == 15) %>%
  select(manufacturer, model)

print(subcompact_data)
```
...
ggplot(sizeMass, aes(x = size_log10, y = mass_log10)) +
  geom_point() +
  geom_smooth(method = "lm", color = "red", se = FALSE)
```
